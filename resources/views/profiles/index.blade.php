                                        ...
                                        <table class="table all-package theme-table" id="table_id">
                                            ...
                                            <tbody>
                                             ...
                                             <!-- Delete Modal Box Start -->
                                                  <div class="modal fade theme-modal remove-coupon" id="exampleModalToggle{{ $agent->id }}" aria-hidden="true" tabindex="-1">
                                                       <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content text-center">
                                                                 ...
                                                                 <div class="modal-footer">
                                                                      ...
                                                                      <a type="a" class="btn btn-animation btn-md fw-bold" href="{{ route('agents.delete',[$agent->id]) }}">Yes</a>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                  </div>
