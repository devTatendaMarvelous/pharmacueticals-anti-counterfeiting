                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="table-image">
                                                                    <img src="{{ asset('storage/'.$req->product->product_photo) }}" class="img-fluid"
                                                                        alt="">
                                                                </div>
                                                            </td>
                                                            <td>{{ $req->product->product_name }}</td>
                                                            <td>{{ $req->product->category->category_name }}</td>
                                                            <td class="td-price">${{ $req->product->selling_price }}</td>
                                                            <td>
                                                                <p class="
                                                            @if ($req->product->product_status==='Low')
                                                                status-danger
                                                            @elseif ($req->product->product_status==='Reorder')
                                                                status-warning
                                                            @elseif ($req->product->product_status==='Good')
                                                                status-close
                                                            @endif
                                                            ">
                                                                    <span>Stock level: {{ $req->product->product_status }}</span>
                                                                </p>
                                                            </td>
                                                            <td>
                                                                <ul>
                                                            ...
                                                            <div class="modal-dialog  modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        <h5 class="modal-title" id="staticBackdropLabel">Reject Verification For {{ $req->product->product_name }}</h5>
