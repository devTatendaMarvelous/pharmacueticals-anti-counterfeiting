                                            ...
                                            <div class="row">
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" name="name" type="text" value="{{$manufacturer->user->name}}" required>
                                                        @error('name')
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" name="email" type="email" required value="{{$manufacturer->user->email}}">
                                                        @error('email')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" name="licence" type="file" >
                                                        @error('photo')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" name="address" required value="{{$manufacturer->address}}">
                                                        @error('address')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-9 col-lg-10">
                                                            <input class="form-control" name="tel" required value="{{$manufacturer->tel}}">
                                                            @error('tel')
                                                            <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                        </div>
